<script setup lang="ts">
	...
	const videos = ref<User>(undefined);
...
<template>
	<header>
		<div class="content">
			<div class="user">
				...
				<div class="texts">
					<div class="names">
						<span class="username">{{ videos?.username }}</span>
	...
	<main>
		<div class="toolbox-card center">
			...
			<PaginationSimple v-model="page" :pages="numberOfPages" :displayPageCount="8" enableArrowKeyMove />
