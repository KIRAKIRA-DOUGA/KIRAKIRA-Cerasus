...
<template>
	...
	<section list>
		<ToggleSwitch v-model:single="focusMode.noSearchRecommendations" v-ripple value="noSearchRecommendations">禁用搜索推荐</ToggleSwitch>
		<ToggleSwitch v-model:single="focusMode.noRelatedVideos" v-ripple value="noRelatedVideos">禁用相关视频</ToggleSwitch>
	</section>

	<Subheader icon="placeholder">隐私</Subheader>
	<section list>
		<ToggleSwitch v-model:single="focusMode.noRecentSearch" v-ripple value="noRecentSearch">停止显示搜索历史</ToggleSwitch>
		<ToggleSwitch v-model:single="focusMode.noViewHistory" v-ripple value="noViewHistory">停用历史记录</ToggleSwitch>
	</section>
