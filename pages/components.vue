<script setup lang="ts">
	...
	function getRandomOp() {
		const ops = [
			...
			"《不定轨》是由紫苏九月自主研发的一部全新代抽。代抽发生在一个被称为「哔哩哔哩直播间」的幻想世界，在这里被选中的人将会被授予「风鹰剑」，引导不定轨之力。你将扮演一位名为「宝宝」的神秘角色，在自由的代抽中邂逅紫苏九月、小N等逆天CV们，和它们一起浪费自己的纠缠之缘⸺同时，逐步发掘「德艺双馨」的真相。",
			"《割声带》是由原婴自主研发的一款全新网暴，割声带发生在一个被称为「哔哩哔哩动态评论区」的网络空间，在这里带节奏的人将被授予「小事见人品」，引导团建之力，你将扮一位名为寄妮太美的神秘元婴期高手，在自由的人身攻击中邂逅菜花花、紫苏九月、Kinsen等CV们，和他们一起宣泄自己的低能欲望⸺同时，逐步发掘「山体滑坡」的真相。",
			"《Windows 11》是由Microsoft自主研发的一款闭源付费无隐私操作系统，系统开发于一个被称作「美国科技霸权」的幻想世界，在这里被基础软件垄断选中的计算机将被授予「后门指令」，引导棱镜计划之力。你将扮演一位名为「无辜的用户」的神秘角色，在自由地使用Windows 11 22H2中邂逅性格各异、能力独特的窃听者们，和它们一起击败国产操作系统，找回敏感信息⸺同时，逐步发掘「强制用户使用微软账号登录」的真相。",
			"《烟神》是由丁真珍珠自主研发的一款全新开放世界冒险游戏。游戏发生在一个被称作「理塘」的幻想世界，在这里，被抖音选中的人将被授予「电子烟」，引导尼古丁之力。你将扮演一位名为「锐刻五」的神秘角色，在自由的旅行中邂逅性格各异、能力独特的动物朋友，和它们一起击败传统香烟，找回不存在的亲人⸺同时，逐步发掘「理塘」的真相。",
			"《椅人》是由椅哈游自主研发的一款全新开放世界抢凳子游戏。游戏发生在一个被称作「椅瓦特」的幻想世界，在这里，被神选中的人将被授予「可以坐的椅子」，导引椅子之力。你将扮演一位名为「椅子哥」的神秘角色，在自由的旅行中邂逅性格各异、能力独特的椅子们，和他们一起击败强敌，找回失散的轮椅⸺同时，逐步发掘「椅人」的真相。",
			"《偷盘子》是由原神玩家自主研发的一款全新现实世界开放模拟经营游戏。游戏发生在一个被称作「必胜客」的西餐厅内，在这里，被联动活动选中的餐具将被授予「联动图案」，导引抽象之力。你将扮演一位名为「三只手」的神秘角色，在用餐偷盘子的过程中邂逅脑里进矢的原批伙伴，和他们一起，创造餐厅盘子不够用的神话⸺同时，逐步发掘「滴嫩儿」的真相。",
			"《三次背叛》是由散兵自主研发的一款全新被害妄想。妄想发生在一个被称作「提瓦特」的幻想世界，在这里，被神选中的人将被授予「风属性」，导引邪眼之力。你将扮演一位名为「斯卡拉姆齐」的神秘角色，在自由的旅行中邂逅性格各异的尼采、能力独特的碇真嗣，和他们一起击败七神，找回散厨不存在的亲人⸺同时，逐步发掘「百岁巨婴」的真相。",
			"《懒设计》是由成都恒图自主研发的一款全新开放世界冒险游戏。游戏发生在一个被称作「B站」的幻想世界，在这里，被无良厂商选中的恰饭仔将被授予「懒设计VIP」，导引拉踩之力。你将扮演一位名为「敖厂长」的神秘角色，在自由的恰饭中邂逅性格各异、能力独特的同伴们，和他们一起击败色情软件，找回死去的亲人骨灰⸺同时，逐步发掘「灰色产业」的真相。",
			"《一坨答辩》是由阿越社自主研发的一款全新开放剧情游戏。游戏发生在一个被称作「B站」的幻想世界，在这里被神选中的人将被授予「创造答辩」引导神之力。你将扮演一位名为「答辩使者」的神秘角色，在自由的日常中邂逅性格各异，能力独特的UP们，看他们的答辩，在他们的评论区制造答辩⸺同时，逐步发掘「答辩」的真相。",
			"《Linux》是由Linus自主研发的一款全新开放源代码操作系统内核。使用该内核的系统运行在一个被称作「ext4」的文件系统，在这里被Kernel选中的人将被授予「Terminal simulator」，引导Shell的力量。你将扮演一位名为「Root」的神秘用户，在自由的使用中邂逅不同开源协议、各有千秋独特的桌面环境和各种软件们，和它们一起服务器运维，找回丢失的软件包⸺同时，逐步发掘「/dev/null」的真相。",
			"《解锁原神风格的自己》是由哔哩哔哩和米哈游联合研发的一款全自动开盒活动。活动发生在一个被称作「B站」的幻想世界，在这里，被李旎选中的人将被免费授予「开盒视频」，导引开盒能力。你将扮演一位名为「倒霉的UP主」的神秘角色，在自由的原神风格视频中邂逅形形色色的开盒照片们，和他们一起泄漏隐私，公开自己的大头照⸺同时，逐步发掘「B站黑产」的真相。",
			"-《⭕⛩️️》💩️🈶️🍚🐸️‍️⛽🚲🐷👁️💈💦️1️⃣️💴👊️❤️▶️‍️🔍🌏️🎩🧵️‍️🎮️。🎮🥜📥️1️⃣️🈹️🛏️🆗️‍️⬅️「🎻🚂」💦️😇🐘️🌏️，️‍📥️‍🌤️💪️，🛏️🈸️☑️🀄️💦️👤️‍️🥇️🛏️✋🌧️「🈸️🈯️👁️」，🗾️☯️⭕🔜🈯️💪️。👇️🥇️🍝️👁️1️⃣️‍️🥀️️‍️🎯🥀️「️🟩⭐🌤️」💦️🈸️㊙️🦶️🔞，️‍📥️🚲🈶️💦️🟩⭐️🀄️✍️🐵️🌟️🈹️🈹️1️⃣️、️🌱💪️☠️™️💦️🌈🍝️🚪，️👘👉🚪1️⃣️7️⃣️🐔️🏳️🔫️💦️，️📸🌠️💩️3️⃣️💦️😚️👤️‍️⸺🌈💩️，㊗️👣💈🤏「️⭕⛩️」💦️💉️🐘️。️",
		];
		let content = randomOne(ops);
		let begin = "你说得对,但是";
