<script setup lang="ts">
	...
	function getRandomOp(index?: number) {
		...
		const ops = [
			...
			"你说得对，但是《Vue》是由尤雨溪自主研发的一款全新开放源代码前端框架。框架发生在一个被称作「模板」的幻想代码，在这里，被模板选中的代码将被授予「语法糖」，导引切图之力。你将扮演一位名为「开发者」的神秘角色，在摸鱼的工作中邂逅性格各异、能力独特的issue们，和他们一起击败bug，找回失散的第三方库⸺同时，逐步发掘「Angular在前端的终点等你」的真相。",
