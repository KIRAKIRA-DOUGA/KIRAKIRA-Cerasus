<script setup lang="ts">
	...
	function getRandomOp(index?: number) {
		...
		const ops = [
			...
			"你说的对，但是《感觉不如O神》是由AGC GAMES自主研发的一款全新恋爱模拟视觉小说。游戏发生在一个被称作「提亚马特」的幻想世界，在这里，被神选中的人将被授予「免费开玩」，导引玩梗之力。你将扮演一位名为「主角」的神秘角色在自由的旅行中邂逅性格各异、能力独特的同伴们，和他们一起击败强敌，找回失散的亲妈⸺同时，逐步发掘「O神」的真相。",
