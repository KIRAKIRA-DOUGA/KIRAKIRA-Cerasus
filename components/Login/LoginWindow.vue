...
<template>
	...
	>
		...
		<div class="login-animation">
			...
			<div class="avatar">
				<NuxtImg v-if="selfUserInfoStore.userInfo.avatar" :provider="getImageProvider(selfUserInfoStore.userInfo.avatar)" :src="selfUserInfoStore.userInfo.avatar" alt="avatar" />
