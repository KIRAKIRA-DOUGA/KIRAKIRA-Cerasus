			...
			<kira-component v-if="open" class="login-window" :class="[currentPage, { 'move-left': coverMoveLeft }] ">
				<div class="main left-wrapper">
					<div class="login">
						...
						<div class="form">
							<TextField v-model="email" type="email" placeholder="邮箱" size="large" icon="email" />
							<TextField v-model="password" type="password" placeholder="密码" size="large" icon="lock" />
				...
				<div class="main right-wrapper">
					<div class="register">
						...
						<div class="form">
							<TextField v-model="email" type="email" placeholder="邮箱" size="large" icon="email" />
							<TextField v-model="password" type="password" placeholder="密码" size="large" icon="lock" />
							<TextField v-model="inviteCode" type="text" placeholder="邀请码" size="large" icon="link" />
						</div>
					...
					<div class="register2">
						...
						<div class="form">
							...
							<TextField v-model="verificationCode" type="text" placeholder="验证码" size="large" icon="verified" />
							<TextField v-model="confirmPassword" type="password" placeholder="确认密码" size="large" icon="lock" />
						</div>
						<div class="action">
					...
					<div class="reset">
						...
						<div class="form">
							...
							<TextField v-model="password" type="password" placeholder="新密码" size="large" icon="lock" />
							<TextField v-model="confirmPassword" type="password" placeholder="确认新密码" size="large" icon="lock" />
						</div>
						<div class="action margin-left-inset">
							<div></div>
							<Button icon="check" class="button" @click="open = false">完成</Button>
