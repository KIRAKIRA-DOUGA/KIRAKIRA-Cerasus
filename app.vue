<script setup lang="ts">
	...
	const cookieThemeColorHex = computed(() => mappingThemeColorHex(useCookie(COOKIE_KEY.themeColorCookieKey, DEFAULT_COOKIE_OPTION).value || THEME_ENV.DEFAULT_THEME_COLOR)); // 主题颜色
	...
	useHead({
		...
		meta: [
			...
			{ name: "theme-color", content: cookieThemeColorHex.value },
