export default {
	...
	block_and_hide: {
		...
		regexp: {
			description: "Use regular expressions to hide content you don't want to see. Do not use two slashes (“/…/”) to enclose it.",
		},
		toasts: {
			cannot_send_danmakus_because_blocked: "You have been blocked by this user, so you cannot send danmakus.",
			cannot_send_comments_because_blocked: "You have been blocked by this user, so you cannot send comments.",
			keyword_char_exceed: "Keywords cannot exceed {0} characters.",
			regexp_in_keyword: "Do not enter regular expressions as keywords.",
			regexp_char_exceed: "Regular expressions cannot exceed {0} characters.",
			regexp_invalid: "The regular expressions you entered is invalid.",
			keyword_invalid: "The keywords you entered is invalid.",
			invalid_uid_requirements: "It cannot be empty or less than or equal to zero.",
			fetch_block_users_failed: "Failed to fetch the information of the users that to be blocked!",
			fetch_block_users_error: "An error occurred while fetching the information of the users that to be blocked!",
			invalid_block_uid: "The UID format for the blocking user is incorrect. @:block_and_hide.toasts.invalid_uid_requirements",
			block_yourself: "Do not block yourself.",
			block_successfully: "Blocked user successfully!",
			block_failed: "Blocked user failed!",
			block_error: "An error occurred while blocking the user!",
			invalid_unblock_uid: "The UID format for the unblocking user is incorrect. @:block_and_hide.toasts.invalid_uid_requirements",
			unblock_successfully: "Unblocked user successfully!",
			unblock_failed: "Unblocked user failed!",
			unblock_error: "An error occurred while unblocking the user!",
			fetch_hide_users_failed: "Failed to fetch the information of the users that to be hidden!",
			fetch_hide_users_error: "An error occurred while fetching the information of the users that to be hidden!",
			invalid_hide_uid: "The UID format for the hiding user is incorrect. @:block_and_hide.toasts.invalid_uid_requirements",
			hide_yourself: "Do not hide yourself.",
			hide_successfully: "Hidden user successfully!",
			hide_failed: "Hidden user failed!",
			hide_error: "An error occurred while hiding the user!",
			invalid_unhide_uid: "The UID format for the unhiding user is incorrect. @:block_and_hide.toasts.invalid_uid_requirements",
			unhide_successfully: "Unhidden user successfully!",
			unhide_failed: "Unhidden user failed!",
			unhide_error: "An error occurred while unhiding the user!",
			block_tag_successfully: "Blocked tag successfully!",
			block_tag_failed: "Blocked tag failed!",
			block_tag_failed_request: "Blocked tag failed! Request failed.",
			unblock_tag_successfully: "Unblocked tag successfully!",
			unblock_tag_failed: "Unblocked tag failed!",
			unblock_tag_failed_request: "Unblocked tag failed! Request failed.",
			block_keyword_successfully: "Blocked keywords successfully!",
			block_keyword_failed: "Blocked keywords failed!",
			block_keyword_failed_request: "Blocked keywords failed! Request failed.",
			unblock_keyword_successfully: "Unblocked keywords successfully!",
			unblock_keyword_failed: "Unblocked keywords failed!",
			unblock_keyword_failed_request: "Unblocked keywords failed! Request failed.",
			block_regexp_successfully: "Blocked regular expressions successfully!",
			block_regexp_failed: "Blocked regular expressions failed!",
			block_regexp_failed_request: "Blocked regular expressions failed! Request failed.",
			unblock_regexp_successfully: "Unblocked regular expressions successfully!",
			unblock_regexp_failed: "Unblocked regular expressions failed!",
			unblock_regexp_failed_request: "Unblocked regular expressions failed! Request failed.",
			fetch_blocklist_failed: "Failed to fetch the blocklist!",
		},
	},
	player: {
		title: "Player",
		...
		filter: {
			...
			h_mirror_left: "Horizontal Mirror (Left)",
			h_mirror_right: "Horizontal Mirror (Right)",
			v_mirror_top: "Vertical Mirror (Top)",
			v_mirror_bottom: "Vertical Mirror (Bottom)",
	...
	preference: {
		...
		focus_mode: {
			title: "Focus Mode",
			no_search_recommendations: "Disable Search Recommendations",
			no_related_videos: "Disable Related Videos",
			no_recent_search: "Hide Recent Searches",
			no_view_history: "Deactivate View History",
		},
		new_window: {
			title: "New Window",
	...
	welcome: {
		title: "Welcome to Join the {kirakira} Family",
		to_join: "Welcome to Join",
		improve_personal_info: "Improve Personal Information",
		exploring: "Exploring {kirakira}",
		agree_agreement: "I have read and agree to the {agreement}",
		agreement: "{kirakira} User Agreement",
	},
	unselected: {
	...
	toast: {
		...
		video_invalid_result: "Fetch video failed! Invalid result.",
		video_request_failed: "Fetch video failed! Request failed.",
		video_no_id: "No video KVID!",
		...
		duplicate_tag_names: "Duplicate tag names are not allowed. Please change it.",
		failed_to_search_duplicate_tags: "Search for duplicate tags failed.",
		failed_to_fetch_user_info: "Failed to fetch user information!",
		failed_to_update_user_info: "Failed to update user information!",
		unable_to_get_cropped_picture: "Unable to get the cropped picture!",
	},
	validation: {
		required: {
