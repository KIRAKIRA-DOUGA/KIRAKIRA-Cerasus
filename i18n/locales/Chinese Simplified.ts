...
export default {
	...
	block_and_hide: {
		...
		regexp: {
			description: "使用正则表达式匹配不想看到的内容。前后无需添加斜杠 (“/…/”)。",
		},
		toasts: {
			cannot_send_danmakus_because_blocked: "你已被该用户屏蔽，因此无法发送弹幕。",
			cannot_send_comments_because_blocked: "你已被该用户屏蔽，因此无法发送评论。",
			keyword_char_exceed: "关键词不能超过{0}个字符。",
			regexp_in_keyword: "请勿在关键词中输入正则表达式。",
			regexp_char_exceed: "正则表达式不能超过{0}个字符。",
			regexp_invalid: "你输入的正则表达式无效。",
			keyword_invalid: "你输入的关键词无效。",
			invalid_uid_requirements: "不能为空或小于等于零。",
			fetch_block_users_failed: "获取待屏蔽用户信息失败！",
			fetch_block_users_error: "获取待屏蔽用户信息时出错！",
			invalid_block_uid: "屏蔽用户的UID格式不正确。@:block_and_hide.toasts.invalid_uid_requirements",
			block_yourself: "不要屏蔽自己。",
			block_successfully: "屏蔽用户成功！",
			block_failed: "屏蔽用户失败！",
			block_error: "屏蔽用户时出错！",
			invalid_unblock_uid: "解除屏蔽用户的UID格式不正确。@:block_and_hide.toasts.invalid_uid_requirements",
			unblock_successfully: "解除屏蔽用户成功！",
			unblock_failed: "解除屏蔽用户失败！",
			unblock_error: "解除屏蔽用户时出错！",
			fetch_hide_users_failed: "获取待隐藏用户信息失败！",
			fetch_hide_users_error: "获取待隐藏用户信息时出错！",
			invalid_hide_uid: "隐藏用户的UID格式不正确。@:block_and_hide.toasts.invalid_uid_requirements",
			hide_yourself: "不要隐藏自己。",
			hide_successfully: "隐藏用户成功！",
			hide_failed: "隐藏用户失败！",
			hide_error: "隐藏用户时出错！",
			invalid_unhide_uid: "恢复显示用户的UID格式不正确。@:block_and_hide.toasts.invalid_uid_requirements",
			unhide_successfully: "恢复显示用户成功！",
			unhide_failed: "恢复显示用户失败！",
			unhide_error: "恢复显示用户时出错！",
			block_tag_successfully: "屏蔽标签成功！",
			block_tag_failed: "屏蔽标签失败！",
			block_tag_failed_request: "屏蔽标签失败！请求失败",
			unblock_tag_successfully: "解除屏蔽标签成功！",
			unblock_tag_failed: "解除屏蔽标签失败！",
			unblock_tag_failed_request: "解除屏蔽标签失败！请求失败",
			block_keyword_successfully: "屏蔽关键词成功！",
			block_keyword_failed: "屏蔽关键词失败！",
			block_keyword_failed_request: "屏蔽关键词失败！请求失败",
			unblock_keyword_successfully: "解除屏蔽关键词成功！",
			unblock_keyword_failed: "解除屏蔽关键词失败！",
			unblock_keyword_failed_request: "解除屏蔽关键词失败！请求失败",
			block_regexp_successfully: "屏蔽正则表达式成功！",
			block_regexp_failed: "屏蔽正则表达式失败！",
			block_regexp_failed_request: "屏蔽正则表达式失败！请求失败",
			unblock_regexp_successfully: "解除屏蔽正则表达式成功！",
			unblock_regexp_failed: "解除屏蔽正则表达式失败！",
			unblock_regexp_failed_request: "解除屏蔽正则表达式失败！请求失败",
			fetch_blocklist_failed: "获取黑名单失败！",
		},
	},
	player: {
		title: "播放器",
		...
		filter: {
			...
			rotate_180: "旋转180度",
			rotate_270: "旋转270度",
			h_mirror_left: "水平镜像（左）",
			h_mirror_right: "水平镜像（右）",
			v_mirror_top: "垂直镜像（上）",
			v_mirror_bottom: "垂直镜像（下）",
			grayscale: "黑白",
			invert: "反色",
			sepia: "怀旧",
			posterize: "色调分离",
	...
	preference: {
		...
		focus_mode: {
			title: "专注模式",
			no_search_recommendations: "禁用搜索推荐",
			no_related_videos: "禁用相关视频",
			no_recent_search: "隐藏最近搜索",
			no_view_history: "停用观看历史",
		},
		new_window: {
			title: "新窗口",
			open_video_in_new_tab: "在新标签页打开视频",
		},
		misc: "杂项",
	...
	login_prompt: {
		history: "登入以查看你的历史",
		collections: "登入以收藏你喜欢的内容",
		following_feed: "登入以查看你关注的所有动态",
		upload: "登入以分享你的内容",
	},
	publish: "投稿",
	messages: "消息",
	...
	loginwindow: {
		...
		login_totp_info: "账号已启用双重验证，请输入动态令牌以继续。\n如果不能访问你的身份验证设备，请使用备份码或恢复码登入。\n注意：使用恢复码登入后，你的账号将禁用双重验证。",
		login_email_info: "邮箱双重验证已在账号上启用，验证码已发送到你的邮箱。\n若未收到验证码，请检查垃圾邮件。",
	},
	welcome: {
		title: "欢迎加入{kirakira}大家庭",
		to_join: "欢迎加入",
		improve_personal_info: "完善个人信息",
		exploring: "开始畅游{kirakira}",
		agree_agreement: "我已阅读并同意{agreement}",
		agreement: "《{kirakira}用户协议》",
	},
	unselected: {
		combobox: "选择一项",
		settings: "请选择一项设置",
	...
	toast: {
		...
		get_current_logged_in_user_info_failed: "获取当前登入用户信息失败！请重新登入",
		...
		video_no_id: "未指定视频KVID！",
		developer_mode_remain_clicks: "再点击{0}次进入开发者模式",
		developer_mode_enabled: "开发者模式已启用~",
		developer_mode_already_enabled: "开发者模式已经处于启用状态了",
		duplicate_tag_names: "不允许标签名重复，请修改",
		failed_to_search_duplicate_tags: "查找重复标签失败",
		failed_to_fetch_user_info: "获取用户信息失败！",
		failed_to_update_user_info: "更新用户信息失败！",
		unable_to_get_cropped_picture: "无法获取裁切后的图片！",
	},
	validation: {
		required: {
			title: "请填写标题！",
	...
	two_factor_authentication: {
		...
		add_totp: {
			...
			step_save: "保存备份码和恢复码",
			step_save_description: "请将它们保存在一个安全的位置。每个备份码或恢复码只能使用一次，离开此页面后将不再显示。如果你无法使用你的身份验证器，你可以使用这些代码登入。",
			backup_code: "备份码",
			backup_code_description: "可以用作动态令牌的替代品。",
			recovery_code: "恢复码",
			recovery_code_description: "不仅可以用作动态令牌的替代品，还将在登入时禁用双重验证。",
			download: "下载代码",
		},
		remove_totp: {
			title: "移除身份验证器",
