...
export default {
	...
	validation: {
		...
		other: {
			...
			username_invaild_or_taken: "Nom d'utilisateur invalide ou déjà pris !",
	...
	announcement: {
		_: "Annonce",
		homepage: "Ce petit site est en pleine croissance ~! Rejoignez notre {discordServer} pour le regarder monter de niveau et discuter avec les développeurs ! (<unk> <unk> <unk> <unk> )文\nVous avez une puissance de codage ? Nous serions très heureux si vous nous avez rejoint dans cette aventure~!! (<unk> •©<unk> •́)و<unk>",
	},
	under_development: {
		feature: "Cette fonctionnalité est encore en cours de développement !",
		feature_admin_only: "Cette fonctionnalité est expérimentale et n'est disponible que pour les administrateurs pour le moment.",
		page: "Cette page est encore en cours de développement, certaines fonctionnalités peuvent ne pas fonctionner comme prévu.",
