...
const Japanese: LocaleIdentifiers = {
	...
	duration: "長さ",
	viewers: "視聴者",
	are_watching: "(test)人が視聴中",
	step_next: "次へ",
	step_previous: "戻る",
	step_ok: "完了",
	step_cancel: "キャンセル",
	loginwindow_login_welcome: "ようこそ",
	loginwindow_login_to_forgot: "(test)パスワードをお忘れの場合",
	loginwindow_login_to_register: "(test)新規登録",
	...
	components_test_page: "(test)コンポーネンツ テストページ",
	send_danmaku: "(test)弾幕を送信",
	view_cover: "(test)サムネイルの確認",
	watch_later: "(test)後で見る",
	download_video: "(test)ダウンロード",
	report_creation: "(test)通報",
	password_hint: "(test)パスワードのヒント",
	forgot_password: "(test)パスワードをお忘れの場合",
	reset_password: "(test)パスワードの再設定",
};
