...
export default {
	...
	tag: {
		...
		search: "タグ検索",
		new: "タグ新規登録",
		set_as_original: "元の名前として設定",
		unset_as_original: "元の名前として設定解除",
	...
	settings: {
		...
		user: "個人設定",
		app: "アプリの設定",
		experimental_warning: "以下の設定は実験的な機能であり、安定して実行したり、複数のデバイス間で同期したりすることは保証されていません。注意して使用してください！",
	},
	dashboard: "ダッシュボード",
	account: "アカウント",
	profile: {
	...
	loginwindow: {
		...
		login_email_info: "メールベースの2FAはあなたのアカウントで有効になっています。確認コードがあなたのメールアドレスに送信されました。\nメールが届かない場合は、迷惑メールフォルダや迷惑メールフォルダをご確認ください。",
	},
	unselected: {
		combobox: "選択してください",
	...
	toast: {
		finish: "操作完了しました",
		something_went_wrong: "問題が発生しました！(; ́<unk> `)<unk> ページを更新して再度お試しください。",
		too_many_requests: "リクエストが多すぎます! ( o『o ) 後でもう一度お試しください。",
		cooling_down: "冷却中! (・_・;) 後でもう一度お試しください。",
	...
	validation: {
		...
		invalid_format: {
			...
			invitation_code: "招待コードのフォーマットが無効です！",
		},
		too_long: {
		...
		other: {
			...
			username_invaild_or_taken: "無効または既にユーザー名を取得しています！",
	...
	under_development: {
		feature: "この機能はまだ開発中です！",
		feature_admin_only: "この機能は実験的であり、現時点では管理者のみ利用できます。",
		page: "このページはまだ開発中です。一部の機能は想定どおりに動作しない場合があります。",
