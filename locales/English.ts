export default {
	...
	loginwindow: {
		...
		login_2fa_info: "2FA is enabled on your account. Please enter your verification code to continue.\nIf you don’t have access to your authentication device, use a backup or recovery code to log in.\nNote: Logging in with a recovery code will disable 2FA on your account after a successful login.",
		login_email_info: "Email-based 2FA is enabled on your account. A verification code has been sent to your email.\nIf you don’t see the email, please check your spam or junk folder.",
	},
	unselected: {
	...
	toast: {
		...
		cooling_down: "Cooling down! Please try again later.",
		...
		get_current_login_user_failed: "Failed to get current logged in user info! Please try logging in again.",
		upvote_failed: "Failed to upvote!",
		undo_upvote_failed: "Failed to undo upvote!",
		downvote_failed: "Failed to downvote!",
		undo_downvote_failed: "Failed to undo downvote!",
		comment_delete_success: "Comment deleted~",
		comment_delete_failed: "Failed to delete comment!",
		cover_view_failed: "Failed to view cover!",
		...
		invitation_code_create_failed: "Failed to create invitation code!",
		verification_code_send_failed: "Failed to send verification code!",
		send_verification_code_no_purpose: "The purpose of sending the verification code must be specified!",
		search_tag_failed: "Failed to search tag!",
		registration_failed: "Registration failed!",
		danmaku_send_failed: "Failed to send danmaku!",
		comment_sent: "Comment sent~",
		comment_send_failed: "Failed to send comment!",
		unsupported_image_format: "Unsupported image format!",
		avatar_crop_failed: "Failed to crop avatar image!",
		avatar_update_failed: "Failed to update avatar!",
		avatar_upload_failed: "Failed to upload avatar!",
		avatar_get_cropped_failed: "Failed to get cropped avatar image!",
	...
	validation: {
		...
		other: {
			...
			username_invaild_or_taken: "Invalid or already taken username!",
	...
	announcement: {
		_: "Announcement",
		homepage: "This little site is still growing~! Join our {discordServer} to watch it level up and chat with the devs! (๑˃ᴗ˂)ﻭ\nGot coding power? We'd be super happy if you joined us on this adventure~!! (๑•̀ㅂ•́)و✧",
	},
	under_development: {
		feature: "This feature is still under development!",
		feature_admin_only: "This feature is experimental and only available to admins for now.",
		page: "This page is still under development, some features may not work as expected.",
