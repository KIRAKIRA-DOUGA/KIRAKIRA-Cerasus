export default {
	...
	toast: {
		...
		something_went_wrong: "Something went wrong! (；´д｀)ゞ Please refresh the page and try again or contact us.",
		...
		required_not_filled: "Please fill in required fields!",
		...
		video_manifest_generate_failed: "Failed to generate video manifest!",
	...
	two_factor_authentication: {
		...
		add_totp: {
			...
			step_enter_code_description: "After scanning the QR code, a verification code will be generated in your authenticator app. {needHelp}\nPlease enter it below and click the OK button before the countdown ends.",
			...
			backup_codes_description: "Can be used as an alternative to TOTP verification codes.",
