...
export default {
	...
	loginwindow: {
		...
		login_totp_info: "账号已启用双重验证，请输入验证码以继续。\n如果不能访问你的身份验证设备，请使用备份码或恢复码登录。\n注意：使用恢复码登录后，你的帐户将禁用双重验证。",
	...
	two_factor_authentication: {
		...
		email_description: "敏感操作时，需要输入发送到邮箱的验证码以继续。",
		totp: "动态令牌（基于时间的一次性密码）",
		totp_description: "敏感操作时，需要输入身份验证器中的验证码以继续。",
		add_totp: {
			_: "添加身份验证器",
			...
			step_enter_code_description: "扫描二维码后，你的身份验证器应用中会生成一个验证码。\n请在下方输入验证码，并在倒计时结束前点击确定按钮。",
			step_save: "保存备份码和恢复码",
