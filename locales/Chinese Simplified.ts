...
export default {
	...
	loginwindow: {
		...
		login_2fa_info: "您的帐户已启用2FA。请输入您的验证码以继续。\n如果您不能访问您的身份验证设备，请使用备用码或恢复码登录。\n注意：使用恢复码登录后，您的帐户将禁用2FA。",
		login_email_info: "基于邮箱的2FA已在您的帐户上启用。验证码已发送到您的邮箱。\n若未收到验证码，请检查垃圾邮件。",
	},
	unselected: {
		combobox: "请选择一项",
		settings: "请选择一项设置",
	...
	toast: {
		...
		upload_must_logged_in: "必须登入后才能上传！",
	...
	validation: {
		required: {
			...
			category: "必须选择分区！",
			email: "必须填写邮箱！",
			email_and_password: "必须填写邮箱和密码！",
			username: "必须填写用户名！",
			verification_code: "必须填写验证码！",
		},
		failed: {
			user_info: "用户信息验证失败！",
		},
		...
		other: {
			...
			username_invaild_or_taken: "用户名无效或已被占用！",
	...
	announcement: {
		_: "公告",
		homepage: "小站还在慢慢进化中～！加入我们的{discordServer}来一起围观开发进展、与开发者交流吧！(๑˃ᴗ˂)ﻭ\n如果你有开发技能，也超级欢迎来加入我们来一起打造它～！！(๑•̀ㅂ•́)و✧",
	},
	under_development: {
		feature: "这个功能还在开发中！",
		feature_admin_only: "这个功能是实验性的，当前仅供管理员使用。",
