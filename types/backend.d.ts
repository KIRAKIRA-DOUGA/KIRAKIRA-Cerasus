 ...
 */
declare global {
	export type { GetVideoCommentByKvidRequestDto, GetVideoCommentByKvidResponseDto, EmitVideoCommentUpvoteRequestDto, EmitVideoCommentDownvoteRequestDto } from "api/Comment/VideoCommentControllerDto";
